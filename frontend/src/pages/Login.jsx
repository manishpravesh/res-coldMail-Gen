...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-dark-950 flex">
        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            <p className="text-dark-400">
              Sign in to continue generating amazing cold emails
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-dark-900/40 text-dark-500">
                  Or continue with
                </span>
              </div>
            </div>
      ...
      {/* Right Side - Visual */}
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-primary-600/20 via-dark-900 to-secondary-600/20 items-center justify-center p-12">
        {/* Background Effects */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="orb orb-primary w-[400px] h-[400px] -top-20 -right-20 opacity-30" />
          <div className="orb orb-secondary w-[300px] h-[300px] bottom-20 -left-20 opacity-30" />
        </div>
        ...
        <div className="relative z-10 text-center max-w-lg">
          ...
          >
            <div className="w-20 h-20 mx-auto mb-8 rounded-2xl bg-gradient-to-br from-primary-500 to-secondary-500 flex items-center justify-center shadow-glow-lg">
              <Sparkles className="w-10 h-10 text-white" />
            </div>
            <h2 className="text-3xl font-bold text-white mb-4">
              Generate Compelling Emails in Seconds
            </h2>
            <p className="text-dark-300 mb-8">
              Our AI analyzes your resume and job descriptions to create
              personalized cold emails that get responses.
            </p>
